...
function Home({ animate }) {
   ...
   const [trendImgs, setTrendImgs] = useState({
      ...
      item1: "1683055485589-Cotton shirt-1.jpg",
      item2: "1683055559620-Oxford shirt-1.jpg",
      item3: "1683056627574-Waxed tie-belt coat-1.jpg",
   });
   ...
   useEffect(() => {
      ...
      if (section === "women") {
         ...
         setTrendImgs({
            ...
            item1: "1683057393396-Regular Fit Oxford shirt-1.jpg",
            item2: "1683057632516-Felted wool-blend car coat-1.jpg",
            item3: "1683057591829-Slim Jeans-1.jpg",
         });
         ...
         setTrendImgs({
            ...
            item1: "1683056826778-Pleated tulle dress-1.jpg",
            item2: "1683057044567-Printed sweatshirt-2.jpg",
            item3: "1683057143507-Superstretch Slim Fit Jeans-1.jpg",
         });
